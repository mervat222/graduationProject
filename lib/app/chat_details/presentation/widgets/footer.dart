                            ...
                            ? Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    height: 20,
                                    child: Image.asset(
                                      'assets/icons/recording_icon.png',
                                      fit: BoxFit.fill,
                                    ),
                                  ),
                                ],
                          ...
                          onTap: () {
                            ...
                            BlocProvider.of<ChatDetailsCubit>(context)
                                .sendMessage(
                                    ...
                                    PublicRequests.currentUser.phone,
                                    widget.user['phone']);
                  ...
                  return GestureDetector(
                    onTap: () {
                      if (state is AudioRecordStarted) {
                        ...
                        BlocProvider.of<ChatDetailsCubit>(context).sendRecord(
                            BlocProvider.of<AudioCubit>(context).path!,
                            PublicRequests.currentUser.phone,
                            widget.user['phone'],
                            PublicRequests.currentUser.type,
                            (LoginCubit.token.isNotEmpty)
                                ? LoginCubit.token
                                : SignUpCubit.token);
                        _timer.cancel();
                        setState(() {
                      ...
                      child: AnimatedScale(
                        ...
                        child: Material(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color:
                                  isAudio ? Colors.white : Colors.transparent,
                              shape: BoxShape.circle,
                            ),
                            width: 60,
                            height: 60,
                            child: Image.asset(
                              'assets/icons/record_audio_icon.png',
                            ),
                          ),
                        ),
                      ),
