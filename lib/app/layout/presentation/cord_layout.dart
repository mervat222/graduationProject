...
import 'package:cord_2/app/login/presentation/choise_screen.dart';
    ...
    return Scaffold(
      bottomNavigationBar: ClipRRect(
        ...
        child: BottomNavigationBar(
          ...
          items: ChoiceScreen.isPatient==true?
          [
      ...
      body: ChoiceScreen.isPatient==true?patientScreens[currentIndex]:assistantScreens[currentIndex]
      // (PublicRequests.currentUser.type == 'patient')
